---
idioma: es
titulo: "Implantes de carga inmediata"
...
cuando_se_indica:
  - "Pérdida de varias piezas que afecta a la estética visible al hablar o sonreír"
  - "El paciente no puede asumir dos meses con la zona sin diente"
  - "Hueso suficiente para dar estabilidad primaria al implante"
proceso:
  - titulo: "Estudio previo"
    descripcion: "Radiografía 3D y escaneado intraoral para medir hueso disponible y planificar posición y número de implantes."
  - titulo: "Cirugía y colocación"
    descripcion: "Retirada de las piezas dañadas y colocación de los implantes en la misma intervención."
  - titulo: "Dientes provisionales fijos"
    descripcion: "Colocación de la prótesis provisional fija el mismo día, para salir de la clínica con dientes."
...
seo:
  titulo_seo: "Implantes de carga inmediata en Barcelona"
  meta_descripcion: "Dientes fijos en un día con implantes de carga inmediata en el Eixample de Barcelona. Estudio previo con radiografía 3D y primera visita gratuita."
---
