...
catàleg": és la planificació coordinada entre totes les especialitats per aconseguir un
resultat que potenciï la teva millor versió amb naturalitat.

## Planificació digital del somriure

Abans de començar qualsevol tractament, dissenyem el teu somriure de forma virtual
...
- **Porcellana**: l'opció de major durabilitat. No es desgasta, manté la brillantor amb
  els anys i és molt resistent a les taques de cafè, vi o tabac. Imita a la perfecció
  la translucidesa de l'esmalt.
- **Composite**: ideal per a correccions més senzilles. En la majoria dels casos es
  modela directament sobre la dent en una sola sessió, gairebé no requereix preparació
...
- **Ambulatori**: fèrules personalitzades i gel professional per fer-ho al teu ritme
