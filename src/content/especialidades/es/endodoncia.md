...
idioma: es
titulo: "Endodoncia"
subtitulo: "Conservar el diente en lugar de extraerlo"
...
faqs:
  - pregunta: "¿Es dolorosa una endodoncia?"
    respuesta: "No. Se realiza con anestesia local y, gracias a la magnificación con microscopio, es un tratamiento predecible y cómodo. El diente suele doler más antes del tratamiento, por la infección, que durante o después de él."
  - pregunta: "¿Cuántas visitas hacen falta?"
    respuesta: "La mayoría de las endodoncias se resuelven en una sola visita. Los retratamientos o los casos con anatomías más complejas pueden requerir una sesión adicional."
  - pregunta: "¿Qué pasa si no me hago la endodoncia?"
    respuesta: "La infección no desaparece por sí sola: progresa hacia el hueso que rodea la raíz y puede acabar provocando la pérdida del diente. Cuanto antes se trata, más sencillo es el tratamiento."
  - pregunta: "¿El diente queda débil después del tratamiento?"
    respuesta: "El diente pierde algo de estructura al eliminar el tejido dañado, por lo que en molares suele recomendarse una corona para protegerlo del desgaste de la masticación."
seo:
  titulo_seo: "Endodoncia en Barcelona | Doria Clinic"
